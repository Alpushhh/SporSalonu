...
namespace SporSalonu.Migrations
{
    ...
    [Migration("20251210154636_AdminEkle")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SporSalonu.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasData(
                        new
                        {
                            Id = "a1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "71724eae-c099-46ab-9a4b-ec9e84612c83",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEIzbh3pdSYeuRHoxmLF/TMpsN0GxRrnTqbHExwwy5E2uQuZTZqAb/AwRPkpmQsiqkQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "68d55361-8954-4368-a59f-00875a0b2057",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SporSalonu.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SporSalonu.Models.Appointment", b =>
                {
                    b.HasOne("SporSalonu.Models.AppUser", "Member")
                        .WithMany()
